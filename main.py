...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7693396870:AAFJMjbOAC304f6G5osYRnbeE-J22VW0t5w")
    API_ID = int(os.environ.get("API_ID",  "21502917"))
    API_HASH = os.environ.get("API_HASH", "fbd85bad63b38d8c0f2c0fd6202f413b")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '8182770544').split(',')
    for i in range(len(AUTH_USERS)):
        AUTH_USERS[i] = int(AUTH_USERS[i])

    GROUPS = os.environ.get('GROUPS', '-4611838651').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = os.environ.get("LOG_CH", "-1002640279309")
...
class Store(object):
    ...
    ADDA_TOKEN = ""
    THUMB_URL = "https://i.ibb.co/nxcqqQ7/Angel.jpg"
